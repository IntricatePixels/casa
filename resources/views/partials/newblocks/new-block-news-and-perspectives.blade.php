@if (get_row_layout() == 'news_and_perspectives')
                ...
                @if ($select_your_posts)
                    @foreach ($select_your_posts as $select_your_post)
                        @php
                            ...
                            $word_count = str_word_count(strip_tags($content)); // Count words in content
                            $reading_speed = 200; // Average reading speed (words per minute)
                            $reading_time = ceil($word_count / $reading_speed); // Calculate reading time (rounded up)
                        @endphp
                        ...
                        <div class="col-lg-4 col-sm-12 my-4 my-lg-3">
                            ...
                            <div class="read-more-section mb-2">
                              ...
                              <p class="font-bold small d-inline-block mb-0">{{ $reading_time }} min read</p>
                            </div>
                            <div>
                              ...
                              <div><a class="d-block mt-lg-3 mt-2 news-link" href="@php echo esc_url($permalink) @endphp">Read More</a></div>
                            </div>
                        </div>
                    @endforeach
            </div>
...
<div class="text-center">
    ...
    @if ($link)
        ...
        @endphp
        <a class="btn btn-primary-gradient mb-5 mt-5 px-5" href="@php echo esc_url( $link_url ) @endphp"
